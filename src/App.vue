...
<template>
  <div class="container">
    ...
    <form @submit.prevent="cadastrarTarefa">
      <div class="row">
        <div class="col">
          <input :value="estado.tarefaTemp" @change="event => estado.tarefaTemp = event.target.value" type="text"
            class="form-control" placeholder="Digite aqui a descrição da sua tarefa">
        </div>
        <div class="col-md-2">
    ...
    <ul class="list-group mt-4">
      <li class="list-group-item" v-for="tarefa in getTarefasFiltradas()">
        <input @click="event => tarefa.finalizada = event.target.checked" :checked="tarefa.finalizada" :id="tarefa.titulo"
          type="checkbox">
